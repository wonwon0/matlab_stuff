function [d_min, pose_prox, pose_prox_pt_act]=verifDistance_v3(limit,pose,L, L_eff,theta)
...
for t=1:n
    ...
    elseif all(limit.limite(t).type=='sphe')
        if limit.limite(t).rayonProxy>norm((pose-limit.limite(t).centroide))
            ...
            d_min(t)=(limit.limite(t).radius-norm((pose-limit.limite(t).centroide)))-0.02;
        else
            d_min(t)=10;
            pose_prox(t,:)=pose;
        end
