...
while 1
    ...
    [normales_effecteur, d_min, pose_prox, poses_prox_pt_act] = collision_manager_matlab(limit, Robot_Pose_j, dh_eff);
    ...
    v_input=verifVitesse_v8(v_prem,normales_effecteur,d_min, min_gap * 1);
