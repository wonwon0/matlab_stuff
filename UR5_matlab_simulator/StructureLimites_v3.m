function limit=StructureLimites_v3()
...
limit.limite(1).surfaces.surface1=[0 0 0;
                                    ...
                                    0 dim 0;
                                    0 0 0] * 1000;
limit.limite(1).surfaces.surface2=[0 0 dim;
                                    dim 0 dim;
                                    dim dim dim;
                                    0 dim dim;
                                    0 0 dim] * 1000;
...
% 
% dim = 0.25;
% limit.limite(3).surfaces.surface1=[0 0 0;
%                                     dim 0 0;
%                                     dim dim 0;
%                                     0 dim 0;
%                                     0 0 0] * 1000;
% limit.limite(3).surfaces.surface2=[0 0 dim;
%                                     dim 0 dim;
%                                     dim dim dim;
%                                     0 dim dim;
%                                     0 0 dim] * 1000;
% limit.limite(3).rayonProxy= 1.5 * 1000;
% limit.limite(3).offset= ([-0.2 0 1]-general_offset) * 1000;
...
%D�finition des centroides de chaque solides
