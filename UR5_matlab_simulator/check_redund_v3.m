function [ vec_norm, d_min] = check_redund_v3(pose_act, vec_norm_redun,d_min,pose_prox)
    ...
    t=pose_prox;
    remove=[];
    vec_norm_redun = vec_norm_redun;
    vec_norm_redun(abs(vec_norm_redun)<0.00001) = 0;
    pose_act = [pose_act, 0 0 0];
    [vec_norm, c, d]=unique(vec_norm_redun,'rows','stable');
...
%     end
    ...
    %vec_norm = [vec_norm zeros(size(vec_norm,1),3)];
end
