function limit=StructureLimites_testbench_force()
...
limit.limite(3).type='sphe';
limit.limite(3).radius=0.65;
limit.limite(3).rayonProxy=1;
limit.limite(3).centroide=[0 0 0.2755];
limit.limite(3).opp=0;

%solide 4

limit.limite(4).type='sphe';
limit.limite(4).radius=0.1;
limit.limite(4).rayonProxy=1;
limit.limite(4).centroide=[-0.3 0.3 0.2755];
limit.limite(4).opp=0.3;

%solide 5

limit.limite(5).type='sphe';
limit.limite(5).radius=0.1;
limit.limite(5).rayonProxy=1;
limit.limite(5).centroide=[-0.3 0.3 0.2755+0.239];
limit.limite(5).opp=0.3;
%solide 6

limit.limite(6).type='tube';
limit.limite(6).surfaces.axe=[0 0 1]/norm([0 0 1]);
limit.limite(6).surfaces.base=[0 0 0];
limit.limite(6).surfaces.longueur=1.5;
limit.limite(6).surfaces.dia=0.12;
limit.limite(6).rayonProxy=limit.limite(6).surfaces.longueur;
limit.limite(6).opp=0.3;

%solide 7

limit.limite(7).type='tube';
limit.limite(7).surfaces.axe=[0 0 1]/norm([0 0 1]);
limit.limite(7).surfaces.base=[0.3 0.3 0];
limit.limite(7).surfaces.longueur=0.5;
limit.limite(7).surfaces.dia=0.12;
limit.limite(7).rayonProxy=limit.limite(7).surfaces.longueur;
limit.limite(7).opp=0.3;

%solide 8

limit.limite(8).type='tube';
limit.limite(8).surfaces.axe=[0 0 1]/norm([0 0 1]);
limit.limite(8).surfaces.base=[0.3-(limit.limite(7).surfaces.dia+0.04) 0.3 0];
limit.limite(8).surfaces.longueur=0.5;
limit.limite(8).surfaces.dia=0.12;
limit.limite(8).rayonProxy=limit.limite(8).surfaces.longueur;
limit.limite(8).opp=0.3;

% %solide 9
% 
% limit.limite(9).type='tube';
% limit.limite(9).surfaces.axe=[1 0 1]/norm([1 0 1]);
% limit.limite(9).surfaces.base=[0.3-(limit.limite(7).surfaces.dia+0.039) 0.3 0];
% limit.limite(9).surfaces.longueur=0.5;
% limit.limite(9).surfaces.dia=0.12;
% limit.limite(9).rayonProxy=limit.limite(8).surfaces.longueur;
