function [dist,pts,G,H ] = GJK_dist_6( shape1, shape2 )
% Prend en argument deux polygones convexes défini en obtjet de type patch
% output:
%   dist: minimal distance between the two solids
%   pts: the points contained in the simplex solution found in the
%           minkowsky representation domain.
%   G: closest point on the solid shape1
%   H: closest point on the solid shape2
% d=rand(1,3);
d=[1 1 1];
%pick a point
