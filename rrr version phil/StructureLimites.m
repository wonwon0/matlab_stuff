function limit=StructureLimites()
...
% limit.limite(8).opp=1;
%solide 9

limit.limite(8).type='poly';
limit.limite(8).surfaces.surface1=[0 0 0;
                                    0 0.3 0;
                                    0.3 0.3 0;
                                    0 0 0];
limit.limite(8).surfaces.surface2=[0 0 0.5;
                                    0 0.3 0.5;
                                    0.3 0.3 0.5;
                                    0 0 0.5];
limit.limite(8).rayonProxy=0.4;
limit.limite(8).offset=[0.2 -0.18 0.1];
