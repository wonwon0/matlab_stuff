...
%LA PREMIÈRE RANGÉE EST ABSOLUMENT CELLE DE L'EFFECTEUR!!!!!
...
[d_min, pose_prox]=verifDistance_v2(limit,pose_init);
...
while 1
    ...
    [d_mins,poses_prox]=verifDistance_v2(limit,pose_act);
    %on garde en mémoir l'input de l'utilisateur
    v_prem=dir;
    %on test si l'input de l'utilisateur n'entre pas en conflit avec une
    %limite
    v_input=verifVitesse_v3(v_prem, d_mins, poses_prox, pose_act,theta_act,L,limit);
