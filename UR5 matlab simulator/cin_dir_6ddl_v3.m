function [Pose, euler, p] = cin_dir_6ddl_v3( q, dh)
...
%                                                        z0 z1 z2 z3 z4 z5))
        ...
        Pose=T;
        euler2=atan2(sqrt(1-T(3,3)^2),T(3,3));
        euler1=atan2(T(2,3)/sin(euler2),T(1,3)/sin(euler2));
        euler3=atan2(T(3,2)/sin(euler2),-T(3,1)/sin(euler2));
