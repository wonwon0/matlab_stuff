...
function [normales_effecteur, d_min, pose_prox, poses_prox_pt_act, h8, poses_articulations] = collision_manager_matlab_v1(limit, Robot_Pose_j, dh_eff, h8, min_distance)
