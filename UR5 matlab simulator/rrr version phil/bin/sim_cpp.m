function sim_cpp(state)
global v1 v2 v3 v4 v5 f1 f2 f3 f4 f5 n c x_move y_move z_move theta1 theta2 theta3 L limit vit dt;
    if state==0
        ...
        theta1=theta_init(1);theta2=theta_init(2);theta3=theta_init(3);
        ...
        while 1
            ...
            [d_min,pose_prox]=verif_dist_rtlab(limit.limite(1).surfaces.surface1,limit.limite(1).surfaces.surface2,limit.limite(1).centroide,limit.limite(1).rayonProxy,pose_act);
