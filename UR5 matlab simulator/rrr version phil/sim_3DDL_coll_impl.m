...
pose_init=[0.3,-0.2,0.2];

%Définition des paramètres DH du robot
L=[0.2755 0.290 0.410 0.0098];
...
set(fig, 'Position', [-1700 50 1500 900])
...
p5=patch('Faces',f5,'Vertices',v5,'FaceVertexCData',c);
set(p5,'facec','flat');
