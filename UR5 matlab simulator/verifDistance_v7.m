function [d_min, poses_prox, pose_prox_pt_act, normales_effecteur]=verifDistance_v7(limit,pose,jacobian, jacobian_eff, pose_eff)
...
for t=1:n
    ...
    normale_effecteur=PointToEffector_v6(vec_norm, jacobian, jacobian_eff);
