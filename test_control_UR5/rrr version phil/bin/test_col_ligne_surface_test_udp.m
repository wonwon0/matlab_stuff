...
while 1
    ...
    a = pos;
    try
    mssg = judp('receive',49939,200); typecast(mssg,'double')
    end
    mssg
    ...
    [d_min,pose_prox,canard_dist]=verifDistance(limit,pose_act);
...
%     theta_next=theta_act+(vit_ang')*dt;
    ...
    judp('send',3333,'132.203.102.154',typecast([1.1 2.2 3.3],'int8'))
